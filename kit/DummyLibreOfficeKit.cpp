...
extern "C"
{
                                  ...
                                  const int nTileHeight)
    {
        ...
        doc_paintTile(pThis, pBuffer, nCanvasWidth, nCanvasHeight, nTilePosX, nTilePosY, nTileWidth,
                      nTileHeight);
    }

    static int doc_getTileMode(LibreOfficeKitDocument* /*pThis*/) { return LOK_TILEMODE_BGRA; }
    ...
    static void doc_resetSelection(LibreOfficeKitDocument* pThis) { (void)pThis; }
    ...
    static int doc_createView(LibreOfficeKitDocument* /*pThis*/) { return 1; }

    static void doc_destroyView(LibreOfficeKitDocument* /*pThis*/, int nId) { (void)nId; }

    static void doc_setView(LibreOfficeKitDocument* /*pThis*/, int nId) { (void)nId; }

    static int doc_getView(LibreOfficeKitDocument* /*pThis*/) { return 1; }

    static int doc_getViewsCount(LibreOfficeKitDocument* /*pThis*/) { return 1; }
