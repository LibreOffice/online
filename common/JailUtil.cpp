...
namespace JailUtil
{
                           ...
                           const std::string& loSubPath)
    {
        ...
        {
            if (!stLink.isLink())
                LOG_WRN("Random device link [" << symlinkSource << "] exists but isn't a link.");
            else
                LOG_TRC("Random device link [" << symlinkSource << "] already exists.");
    ...
    void setupSysTemplate_DynamicFiles(const std::string& sysTemplate)
    {
    ...
    void updateSysTemplate_DynamicFiles(const std::string& sysTemplate)
    {
        if (!LinkDynamicFiles)
        {
    ...
    void setupSysTemplate_LoSymlink(const std::string& sysTemplate, const std::string& loTemplate,
                                    const std::string& loSubPath)
    {
    ...
    void setupSysTemplate_RandomDeviceLink(const std::string& sysTemplate, const std::string& name)
    {
    ...
    void setupSysTemplate_RandomDeviceLinks(const std::string& sysTemplate)
    {
        setupSysTemplate_RandomDeviceLink(sysTemplate, "random");
        setupSysTemplate_RandomDeviceLink(sysTemplate, "urandom");
    }
    ...
    void setupJail_DevNodes(const std::string& root)
    {
