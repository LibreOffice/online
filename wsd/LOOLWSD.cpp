...
//              Util::dumpHex(std::cerr, "clipboard:\n", "", socket->getInBuffer()); // lots of data ...
                           ...
                           const std::shared_ptr<StreamSocket>& socket)
    {
        ...
        if (requestDetails.equals(2, "convert-to"))
        {
        ...
        else if (requestDetails.equals(3, "insertfile"))
        {
            ...
            if (form.has("childid") && form.has("name"))
            {
                ...
                URI::decode(requestDetails[2], decodedUri);
        ...
        else if (requestDetails.size() >= 6)
        {
            ...
            if (docBrokerIt->second->getJailId() == requestDetails[4])
            {
            ...
            std::string fileName;
            URI::decode(requestDetails[5], fileName);
            const Path filePath(LOOLWSD::ChildRoot + requestDetails[3]
                                + JAILED_DOCUMENT_ROOT + requestDetails[4] + "/" + fileName);
