...
void LOOLWSD::initialize(Application& self)
{
    ...
    static const std::map<std::string, std::string> DefAppConfig
        = { { "allowed_languages", "de_DE en_GB en_US es_ES fr_FR it nl pt_BR pt_PT ru" },
            ...
            { "storage.ssl.enable", "true" },
            { "storage.ssl.cert_file_path", LOOLWSD_CONFIGDIR "/storage_cert.pem" },
            { "storage.ssl.key_file_path", LOOLWSD_CONFIGDIR "/storage_key.pem" },
            { "storage.ssl.ca_file_path", LOOLWSD_CONFIGDIR "/storage_ca-chain.cert.pem" },
