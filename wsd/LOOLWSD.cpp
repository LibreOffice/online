...
std::map<std::string, std::string> LOOLWSD::OSInfo;
...
void LOOLWSD::getOSInfo(){
        ...
        std::vector<std::string> infoList = GeneralTools::splitStringToVector(str, '\n');
        LOOLWSD::OSInfo = GeneralTools::stringVectorToMap(infoList, '=');
    #else
