...
Poco::Net::HTTPRequest WopiStorage::createHttpRequest(const std::string& verb, const Poco::URI& uri,
                                                      const Authorization& auth,
                                                      const std::string& cookies) const
{
    Poco::Net::HTTPRequest request(verb, uri.getPathAndQuery(), Poco::Net::HTTPMessage::HTTP_1_1);
                                                                        ...
                                                                        LockContext& lockCtx)
{
    ...
    try
    {
        Poco::Net::HTTPRequest request
            = createHttpRequest(Poco::Net::HTTPRequest::HTTP_GET, uriObject, auth, cookies);
                                  ...
                                  LockContext& lockCtx, bool lock)
{
    ...
    try
    {
        ...
        Poco::Net::HTTPRequest request
            = createHttpRequest(Poco::Net::HTTPRequest::HTTP_POST, uriObject, auth, cookies);
