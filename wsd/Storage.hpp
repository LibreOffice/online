...
public:
    ...
    public:
        FileInfo(const std::string& filename,
                 ...
                 const std::chrono::high_resolution_clock::time_point& modifiedTime,
                 size_t /*size*/)
            : _filename(filename),
              _ownerId(ownerId),
        ...
        void setModifiedTime(const std::chrono::high_resolution_clock::time_point& modifiedTime) { _modifiedTime = modifiedTime; }

        const std::chrono::high_resolution_clock::time_point& getModifiedTime() const { return _modifiedTime; }

    private:
        std::string _filename;
        std::string _ownerId;
        std::chrono::high_resolution_clock::time_point _modifiedTime;
    };
    ...
    StorageBase(const Poco::URI& uri,
        ...
        _jailPath(jailPath),
        _fileInfo("", "lool", Util::getTimeNow(), 0),
        _isLoaded(false),
        _forceSave(false),
