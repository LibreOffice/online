...
void AdminModel::getMetrics(AdminMetrics &metrics)
{
    ...
    int unassignedProcCount = getPidsFromProcName(std::regex("kit_spare_[0-9]*"), &childProcs);
    int assignedProcCount = getPidsFromProcName(std::regex("kitbroker_[0-9]*"), &childProcs);
