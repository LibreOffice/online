...
std::string WsdStats::WsdHistory::getAllHistory()
{
    std::ostringstream ossE;
    ossE << "WsdHistory:\n\nEvents:\n";
    for (auto elem : *(this->_events) )
    {
    ...
    ossD << "\nDocuments:\n";
    for (auto mapIt : *(this->_allSnapshotsMap) )
    {
        ossD << "   " << mapIt.first << ":\n";
...
/// TODO: it will be implemented using Poco::JSON
std::string WsdStats::WsdHistory::getAllHistoryAsJSON()
{
    return std::string("");
}
