...
bool isConfigAuthOk(const std::string& userProvidedPwd)
{
    ...
    if (config.has("admin_console.secure_password"))
    {
        ...
        if (securePass.empty())
        {
            LOG_ERR("Admin Console secure password is empty, denying access until set.");
            return false;
        }
    ...
    if (pass.empty())
    {
        LOG_ERR("Admin Console password is empty, denying access until set.");
        return false;
    }
                                               ...
                                               HTTPResponse &response)
{
    ...
    else
    {
        ...
        if (!isConfigAuthOk(userProvidedPwd))
            return false;
    }
