...
public:
    Document(const std::string& docKey,
        ...
        : _docKey(docKey),
          ...
          _snapshots(std::set<std::shared_ptr<Poco::JSON::Object>>())
    {
    }
    ...
    const std::set<std::shared_ptr<Poco::JSON::Object>>& getHistory() const{ return _snapshots; }
...
private:
    ...
    std::set<std::shared_ptr<Poco::JSON::Object>> _snapshots;
};
