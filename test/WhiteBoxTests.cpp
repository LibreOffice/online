...

    {
        const std::string WorkingDocumentURI
            = "https://example.com:8443/rest/files/wopi/files/"
              "8ac75551de4d89e60002?access_header=Authorization%3A%2520Bearer%"
              "25201hpoiuytrewq%250D%250A%250D%250AX-Requested-With%3A%"
              "2520XMLHttpRequest&reuse_cookies=lang%3Den-us%3A_xx_%3DGS1.1."
              "%3APublicToken%"
              "3DeyJzdWIiOiJhZG1pbiIsImV4cCI6MTU4ODkxNzc3NCwiaWF0IjoxNTg4OTE2ODc0LCJqdGkiOiI4OGZhN2"
              "E3ZC"
              "1lMzU5LTQ2OWEtYjg3Zi02NmFhNzI0ZGFkNTcifQ%3AZNPCQ003-32383700%3De9c71c3b%"
              "3AJSESSIONID%"
              "3Dnode019djohorurnaf1eo6f57ejhg0520.node0&permission=edit";
