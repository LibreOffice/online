...
void WhiteBoxTests::testLOOLProtocolFunctions()
{
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), Util::trimmed("A").size());
    CPPUNIT_ASSERT_EQUAL(std::string("A"), Util::trimmed("A"));

    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), Util::trimmed(" X").size());
    CPPUNIT_ASSERT_EQUAL(std::string("X"), Util::trimmed(" X"));

    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), Util::trimmed("Y ").size());
    CPPUNIT_ASSERT_EQUAL(std::string("Y"), Util::trimmed("Y "));

    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), Util::trimmed(" Z ").size());
    CPPUNIT_ASSERT_EQUAL(std::string("Z"), Util::trimmed(" Z "));

    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(0UL), Util::trimmed(" ").size());
    ...
    s = "A";
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), Util::trim(s).size());
    s = "A";
    ...
    s = " ";
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(0UL), Util::trim(s).size());
    s = " ";
...
void WhiteBoxTests::testSplitting()
{
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(5UL), Util::getLastDelimiterPosition("aa.bb.cc", 8, '.'));
...
void WhiteBoxTests::testTokenizer()
{
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(0UL), tokens.size());

    tokens = LOOLProtocol::tokenize("  ");
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(0UL), tokens.size());

    tokens = LOOLProtocol::tokenize("A");
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), tokens.size());
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(2UL), tokens.size());
    CPPUNIT_ASSERT_EQUAL(std::string("A"), tokens[0]);
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(10UL), tokens.size());
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(1UL), ints.size());
    CPPUNIT_ASSERT_EQUAL(-1, ints[0]);

    ints = LOOLProtocol::tokenizeInts(std::string("1,2,3,4"));
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(4UL), ints.size());
    CPPUNIT_ASSERT_EQUAL(1, ints[0]);
    ...
    CPPUNIT_ASSERT_EQUAL(static_cast<size_t>(0UL), ints.size());
