...
L.Control.PartsPreview = L.Control.extend({
	...
	_addDnDTouchHandlers: function (e) {
		...
		var panstart = new CustomEvent('panstart', e);
		e.target.dispatchEvent(panstart);
	},

	_removeDnDTouchHandlers: function (e) {
		console.log('Pranam: remove');
	...
	_handlePanMove: function (e) {
		...
		} else if (this.currentNode.id === 'first-drop-site') {
