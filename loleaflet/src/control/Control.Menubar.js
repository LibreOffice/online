		...
		text:  [
			{name: _UNO('.uno:PickList', 'text'), id: 'file', type: 'menu', menu: [
				...
				{name: _('Download as'), id: 'downloadas', type: 'menu', menu: [
					...
					{name: _('Word 2003 (.doc)'), id: 'downloadas-doc', type: 'action'},
					{name: _('Word (.docx)'), id: 'downloadas-docx', type: 'action'},
		...
		presentation: [
			{name: _UNO('.uno:PickList', 'presentation'), id: 'file', type: 'menu', menu: [
				...
				{name: _('Download as'), id: 'downloadas', type: 'menu', menu: [
					...
					{name: _('PowerPoint 2003 (.ppt)'), id: 'downloadas-ppt', type: 'action'},
					{name: _('PowerPoint (.pptx)'), id: 'downloadas-pptx', type: 'action'}]},
				{type: 'separator'},
				{uno: '.uno:SetDocumentProperties'}
			]},
		...
		spreadsheet: [
			{name: _UNO('.uno:PickList', 'spreadsheet'), id: 'file', type: 'menu', menu: [
				...
				{name: _('Download as'), id:'downloadas', type: 'menu', menu: [
					...
					{name: _('Excel 2003 (.xls)'), id: 'downloadas-xls', type: 'action'},
					{name: _('Excel (.xlsx)'), id: 'downloadas-xlsx', type: 'action'}]},
				{type: 'separator'},
				{uno: '.uno:SetDocumentProperties'}
			]},
