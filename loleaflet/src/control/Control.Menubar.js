...
L.Control.Menubar = L.Control.extend({
	...
	_executeAction: function(item) {
		...
		if (id === 'save') {
			...
			var self = this;
			vex.dialog.alert({
				message: _('<p>Your browser has very limited access to the clipboard, so use these keyboard shortcuts:<ul><li><b>Ctrl+C</b>: For copying.</li><li><b>Ctrl+X</b>: For cutting.</li><li><b>Ctrl+P</b>: For pasting.</li></ul></p>'),
				callback: function () {
					self._map.focus();
				}
			});
