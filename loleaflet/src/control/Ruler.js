...
L.Control.Ruler = L.Control.extend({
	...
	_updateParagraphIndentations: function() {
		...
		var fLinePosition = this.options.DraggableConvertRatio * (this.options.nullOffset + this.options.firstLineIndent) + this.rulerOffset;
		var pStartPosition = this.options.DraggableConvertRatio * (this.options.nullOffset + this.options.leftParagraphIndent) + this.rulerOffset;
		var pEndPosition = this.options.DraggableConvertRatio * (this.options.nullOffset + this.options.rightParagraphIndent) + this.rulerOffset;
