...
L.Control.Ruler = L.Control.extend({
	...
	_updateParagraphIndentations: function() {
		...
		this._firstLineMarker.style.left = (fLinePosition - (this._firstLineMarker.getBoundingClientRect().width / 1.0)) + 'px';
		this._pStartMarker.style.left = (pStartPosition - (this._pStartMarker.getBoundingClientRect().width / 1.0)) + 'px';
		this._pEndMarker.style.left = (pEndPosition - (this._pEndMarker.getBoundingClientRect().width / 1.0)) + 'px';
