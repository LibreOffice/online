	...
	_onMessage: function (e) {
		...
		if (textMsg.startsWith('loolserver ')) {
			...
			if (command.errorKind === 'limitreached' && !this.WasShownLimitDialog) {
				...
				textMsg = textMsg.replace(/{productname}/g, (typeof brandProductName !== 'undefined' ? brandProductName : 'LibreOffice Online'));
				brandProductFAQURL = (typeof brandProductFAQURL !== 'undefined') ? brandProductFAQURL : 'https://hub.libreoffice.org/professional-online-support';
