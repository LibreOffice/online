			...
			for (var i = 0; i < docList.length; i++) {
				...
				for (var j = 0; j < userListJson.length; j++) {
					...
					if ($userListRow.length == 0) {
						...
						$number = $(document.createElement('div')).addClass('doc_number').attr('id', 'num' + encodedUName).text(1);
						...
						docCount = parseInt($('#num' + encodedUName).text())
						$('#num' + encodedUName).text(docCount + 1);
