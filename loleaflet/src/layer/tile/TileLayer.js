...
L.TileLayer = L.GridLayer.extend({
	...
	_onUserListRefresh: function(map, toolbar) {
		...
		map.off('deselectuser', window.deselectUser).on('deselectuser', window.deselectUser);
		map.off('addview', window.onAddView).on('addview', window.onAddView);
		map.off('removeview', window.onRemoveView).on('removeview', window.onRemoveView);
