...
//			}
	...
	_updateCursorPos: function () {
		let pixBounds = L.bounds(this._map.latLngToLayerPoint(this._visibleCursor.getSouthWest()),
			this._map.latLngToLayerPoint(this._visibleCursor.getNorthEast()));
		let cursorSize = pixBounds.getSize().multiplyBy(this._map.getZoomScale(this._map.getZoom()));
		let cursorPos = this._visibleCursor.getNorthWest();
